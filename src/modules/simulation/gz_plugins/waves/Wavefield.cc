...
void Wavefield::Implementation::FillParameters()
{
  ...
  auto *mutable_params = this->params.mutable_params();
  ...
  (*mutable_params)["cell_count"] = cellCountValue;
  ...
  (*mutable_params)["number"] = numberValue;
  ...
  (*mutable_params)["scale"] = scaleValue;
  ...
  (*mutable_params)["angle"] = angleValue;
  ...
  (*mutable_params)["steepness"] = steepnessValue;
  ...
  (*mutable_params)["amplitude"] = amplitudeValue;
  ...
  (*mutable_params)["period"] = periodValue;
  ...
  (*mutable_params)["phase"] = phaseValue;
  ...
  (*mutable_params)["direction"] = directionValue;
  ...
  double _time, double _timeInit)
{
  ...
  return h * (1.0 - exp(-1.0 * (_time - _timeInit) / ((double) this->Tau())));
}
  ...
  double _time, double _timeInit)
{
  ...
  auto wave_fdf = [=](auto x, auto p, auto t, auto &wp, auto &F, auto &J)
  {
    ...
    // Exponentially grow the waves
    return pz * (1.0 - exp(-1.0 * (_time - _timeInit) / (double)this->Tau()));
  };
